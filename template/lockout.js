(function(W) {
    ...
    if (!hasPromise) {
        ...
        D.body.innerHTML = '<div style="margin:20px auto; font-family: sans-serif; width:400px; text-align:center;">' +
            'This browser is not supported.<br/> Please use the Chrome browser to access this application.' + 
            '</div>';
        try {W.stop()} catch (e) {}

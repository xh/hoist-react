# Changelog Archive (Pre-v56)

This file contains the changelog for hoist-react versions prior to v56. For current versions,
see the main [CHANGELOG.md](../../CHANGELOG.md).

...
|---|---|---|---|---|---|
| 88.0 | 40.5.0 | 41.0 | 41.0 | No new core requirement. Client-only: CSS variable override hooks removed, `css-data.json` added | [Notes](./upgrade-notes/v88-upgrade-notes.md) |

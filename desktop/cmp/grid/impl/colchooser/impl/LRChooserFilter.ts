 ...
 */
import {hoistCmp, HoistModel, useLocalModel, uses, lookup, HoistProps} from '@xh/hoist/core';
...
export interface LRChooserFilterProps extends HoistProps {
 ...
 */
export const [LRChooserFilter, lrChooserFilter] = hoistCmp.withFactory<LRChooserFilterProps>({
    displayName: 'LRChooserFilter',
...
class LocalModel extends HoistModel {
    /** @member {LRChooserModel} */
    @lookup(LRChooserModel) model;

...
export class TreeMapModel extends HoistModel {
     ...
     * @param {number} [c.maxLabels] - Maximum number of node labels to attempt to render. Defaults
     *      to 250, based on the fact that the smaller boxes beyond that count are unlikely to be able
     *      to have enough room to render labels in any case.  Be aware that increasing this can
     *      degrade performance.
     ...
     *      value in the default tooltip. Note that any renderer or formatter provided should be
     *      configured to return `asHtml`
     * @param {TreeMapModel~heatRendererFn} [c.heatRenderer] - Renderer to use when displaying heat
     *      in the default tooltip. Note that any renderer or formatter provided should be
     *      configured to return `asHtml`

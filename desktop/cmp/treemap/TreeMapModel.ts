 ...
 */
export interface TreeMapModelConfig {
    ...
    /** Maximum number of nodes to render. Be aware that increasing this can severely degrade perfsormance. */
    maxNodes?: number,
...
export class TreeMapModel extends HoistModel {
    ...
    constructor(config: TreeMapModelConfig) {
        super();
        makeObservable(this);

            ...
            tabs.push({
                ...
                content: viewsGrid({
                    ...
                    helpText: fragment(
                        ...
                        br(),
                        `${capitalize(globalViews)} will be set to appear by default in everyone's menu, but you can choose which ${views} you would like to see by pinning/unpinning them at any time.`
                    )
                })
            });
        }

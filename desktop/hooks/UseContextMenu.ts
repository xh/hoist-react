...
import {contextMenu as contextMenuEl, ContextMenuItemLike} from '@xh/hoist/desktop/cmp/contextmenu/ContextMenu';
import {ContextMenu} from '@xh/hoist/kit/blueprint';
import {isArray, isFunction, isUndefined, isEmpty} from 'lodash';
import {ReactElement} from 'react';
import {cloneElement, isValidElement} from 'react';

export type UseContextMenuSpec = ContextMenuItemLike[]|((e: MouseEvent) => ContextMenuItemLike[])|ReactElement;
 ...
 * @param contextMenu -  Array of ContextMenuItems, configs to create them,
 ...
 */
export function useContextMenu(child?: ReactElement, contextMenu?: UseContextMenuSpec): ReactElement {

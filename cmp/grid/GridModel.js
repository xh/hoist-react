...
export class GridModel extends HoistModel {
     ...
     * @param {(?string|?ReactNode)} [c.emptyText] - text/element to display if grid has no records.
     ...
     * @param {(?string|?ReactNode)} emptyText - text/element to display if grid has no records.
     */
    @action

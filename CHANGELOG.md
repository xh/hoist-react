...
* Added a new Persistence API (`@xh/hoist/persistence`) to support flexibly saving state for
  ...
  * This same API is now used to handle state persistence for `GridStateModel` and `PanelModel`,

...
* `MessageModel` now accepts `allowEscape` and `cancelOnEscape` props to control the behavior of a
  popup message when clicking the backdrop or hitting the escape key.

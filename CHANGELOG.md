...
* The options for `useOnResize` are now set as an object, and now include `runOnVisible` to
  always trigger the function when becoming visible, regardless of size changes.

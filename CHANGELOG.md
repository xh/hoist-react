...
* The Admin console's Activity Tracking tab has been significantly upgraded to allow admins to
  better analyze both built-in and custom tracking data generated by their application.
...
* Applications should update to `hoist-core` v7.1 or above, required to support the upgraded Admin

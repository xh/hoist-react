...
export const Icon = {
    ...
    add(p)              {return Icon.icon({...p,  iconName: 'plus'})},
    ...
    chartBar(p)         {return Icon.icon({...p,  iconName: 'chart-column'})},
    ...
    download(p)         {return Icon.icon({...p,  iconName: 'arrow-down-to-bracket'})},
    ...
    gauge(p)            {return Icon.icon({...p,  iconName: 'gauge-high'})},
    ...
    magic(p)            {return Icon.icon({...p,  iconName: 'wand-magic-sparkles'})},
    ...
    mobile(p)           {return Icon.icon({...p,  iconName: 'mobile-screen'})},
    ...
    pointerUp(p)        {return Icon.icon({...p,  iconName: 'hand-point-up'})},
    ...
    report(p)           {return Icon.icon({...p,  iconName: 'file-chart-column'})},
    ...
    sortArrows(p)       {return Icon.icon({...p, iconName: 'arrow-up-arrow-down'})},
    sortAlphaAsc(p)        {return Icon.icon({...p, iconName: 'arrow-down-a-z'})},
    sortAlphaDesc(p)     {return Icon.icon({...p, iconName: 'arrow-down-z-a'})},
    sortNumericAsc(p)      {return Icon.icon({...p, iconName: 'arrow-down-1-9'})},
    sortNumericDesc(p)   {return Icon.icon({...p, iconName: 'arrow-down-9-1'})},
    ...
    treeList(p)         {return Icon.icon({...p,  iconName: 'list-tree'})},
    ...
    upload(p)           {return Icon.icon({...p,  iconName: 'arrow-up-from-bracket'})},

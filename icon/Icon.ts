...
export const Icon = {
    ...
    arrowDownToBracket(p?: IconProps)   {return Icon.icon({...p, iconName: 'arrow-down-to-bracket'})},
    ...
    arrowRightArrowLeft(p?: IconProps)  {return Icon.icon({...p, iconName: 'arrow-right-arrow-left'})},
    ...
    arrowUpFromBracket(p?: IconProps)   {return Icon.icon({...p, iconName: 'arrow-up-from-bracket'})},
    arrowsLeftRight(p?: IconProps)      {return Icon.icon({...p, iconName: 'arrows-h'})},
    arrowsRotate(p?: IconProps)         {return Icon.icon({...p, iconName: 'arrows-rotate'})},
    ...
    fileCertificate(p?: IconProps)      {return Icon.icon({...p, iconName: 'file-certificate'})},
    fileChart(p?: IconProps)            {return Icon.icon({...p, iconName: 'file-chart-column'})},
    ...
    floppyDisk(p?: IconProps)           {return Icon.icon({...p, iconName: 'floppy-disk'})},
    ...
    funnel(p?: IconProps)               {return Icon.icon({...p, iconName: 'filter'})},
    ...
    infoCircle(p?: IconProps)           {return Icon.icon({...p, iconName: 'info-circle'})},
    ...
    magnifyingGlass(p?: IconProps)      {return Icon.icon({...p, iconName: 'magnifying-glass'})},
    ...
    mixedChart(p?: IconProps)           {return Icon.icon({...p, iconName: 'analytics'})},
    ...
    paperclip(p?: IconProps)            {return Icon.icon({...p, iconName: 'paperclip'})},
    ...
    penToSquare(p?: IconProps)          {return Icon.icon({...p, iconName: 'pen-to-square'})},
    ...
    slashedCircle(p?: IconProps)        {return Icon.icon({...p, iconName: 'ban'})},
    ...
    userCheck(p?: IconProps)            {return Icon.icon({...p, iconName: 'user-check'})},
    ...
    xHexagon(p?: IconProps)             {return Icon.icon({...p, iconName: 'times-hexagon'})},

    /**
     * Allows apps to override Hoist choices for given icons.
     */
    accessDenied(p?: IconProps)                 {return Icon.slashedCircle(p)},
    add(p?: IconProps)                          {return Icon.plus(p)},
    analytics(p?: IconProps)                    {return Icon.mixedChart(p)},
    approve(p?: IconProps)                      {return Icon.userCheck(p)},
    attachment(p?: IconProps)                   {return Icon.paperclip(p)},
    close(p?: IconProps)                        {return Icon.x(p)},
    columnMenu(p?: IconProps)                   {return Icon.bars(p)},
    danger(p?: IconProps)                       {return Icon.xCircle(p)},
    delete(p?: IconProps)                       {return Icon.minusCircle(p)},
    detail(p?: IconProps)                       {return Icon.magnifyingGlass(p)},
    diff(p?: IconProps)                         {return Icon.arrowRightArrowLeft(p)},
    disabled(p?: IconProps)                     {return Icon.slashedCircle(p)},
    download(p?: IconProps)                     {return Icon.arrowDownToBracket(p)},
    edit(p?: IconProps)                         {return Icon.penToSquare(p)},
    error(p?: IconProps)                        {return Icon.xHexagon(p)},
    favorite(p?: IconProps)                     {return Icon.star(p)},
    filter(p?: IconProps)                       {return Icon.funnel(p)},
    groupRowCollapsed(p?: IconProps)            {return Icon.angleRight(p)},
    groupRowExpanded(p?: IconProps)             {return Icon.angleDown(p)},
    info(p?: IconProps)                         {return Icon.infoCircle(p)},
    instrument(p?: IconProps)                   {return Icon.fileCertificate(p)},
    menu(p?: IconProps)                         {return Icon.bars(p)},
    panelCollapseToggleDown(p?: IconProps)      {return Icon.chevronDown(p)},
    panelCollapseToggleLeft(p?: IconProps)      {return Icon.chevronLeft(p)},
    panelCollapseToggleRight(p?: IconProps)     {return Icon.chevronRight(p)},
    panelCollapseToggleUp(p?: IconProps)        {return Icon.chevronUp(p)},
    refresh(p?: IconProps)                      {return Icon.arrowsRotate(p)},
    report(p?: IconProps)                       {return Icon.fileChart(p)},
    save(p?: IconProps)                         {return Icon.floppyDisk(p)},
    search(p?: IconProps)                       {return Icon.magnifyingGlass(p)},
    selectDropdown(p?: IconProps)               {return Icon.chevronDown(p)},
    sortAbsAsc(p?: IconProps)                   {return Icon.arrowToTop(p)},
    sortAbsDesc(p?: IconProps)                  {return Icon.arrowToBottom(p)},
    sortAsc(p?: IconProps)                      {return Icon.arrowUp(p)},
    sortDesc(p?: IconProps)                     {return Icon.arrowDown(p)},
    success(p?: IconProps)                      {return Icon.checkCircle(p)},
    sync(p?: IconProps)                         {return Icon.arrowsRotate(p)},
    transaction(p?: IconProps)                  {return Icon.arrowRightArrowLeft(p)},
    upload(p?: IconProps)                       {return Icon.arrowUpFromBracket(p)},

...
export const Icon = {
    ...
    arrowUpToBracket(p?: IconProps)     {return Icon.icon({...p, iconName: 'arrow-up-to-bracket'})},
    ...
    hexagonXMark(p?: IconProps)         {return Icon.icon({...p, iconName: 'times-hexagon'})},
    ...
    timesCircle(p?: IconProps)          {return Icon.icon({...p, iconName: 'times-circle'})},
    ...
    danger:                         (p?: IconProps) => Icon.timesCircle({...p}),
    ...
    error:                          (p?: IconProps) => Icon.hexagonXMark({...p}),
    ...
    upload:                         (p?: IconProps) => Icon.arrowUpToBracket({...p}),

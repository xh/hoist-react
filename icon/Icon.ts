...
export const Icon = {
     ...
     */
    accessDenied:                   (p?: IconProps) => Icon.slashedCircle({...p}),
    add:                            (p?: IconProps) => Icon.plus({...p}),
    analytics:                      (p?: IconProps) => Icon.mixedChart({...p}),
    approve:                        (p?: IconProps) => Icon.userCheck({...p}),
    attachment:                     (p?: IconProps) => Icon.paperclip({...p}),
    close:                          (p?: IconProps) => Icon.x({...p}),
    columnMenu:                     (p?: IconProps) => Icon.bars({...p}),
    danger:                         (p?: IconProps) => Icon.xCircle({...p}),
    delete:                         (p?: IconProps) => Icon.minusCircle({...p}),
    detail:                         (p?: IconProps) => Icon.magnifyingGlass({...p}),
    diff:                           (p?: IconProps) => Icon.arrowRightArrowLeft({...p}),
    disabled:                       (p?: IconProps) => Icon.slashedCircle(),
    download:                       (p?: IconProps) => Icon.arrowDownToBracket({...p}),
    edit:                           (p?: IconProps) => Icon.penToSquare({...p}),
    error:                          (p?: IconProps) => Icon.xHexagon({...p}),
    favorite:                       (p?: IconProps) => Icon.star({...p}),
    filter:                         (p?: IconProps) => Icon.funnel({...p}),
    groupRowCollapsed:              (p?: IconProps) => Icon.angleRight({...p}),
    groupRowExpanded:               (p?: IconProps) => Icon.angleDown({...p}),
    info:                           (p?: IconProps) => Icon.infoCircle({...p}),
    instrument:                     (p?: IconProps) => Icon.fileCertificate({...p}),
    menu:                           (p?: IconProps) => Icon.bars({...p}),
    panelCollapseToggleDown:        (p?: IconProps) => Icon.chevronDown({...p}),
    panelCollapseToggleLeft:        (p?: IconProps) => Icon.chevronLeft({...p}),
    panelCollapseToggleRight:       (p?: IconProps) => Icon.chevronRight({...p}),
    panelCollapseToggleUp:          (p?: IconProps) => Icon.chevronUp({...p}),
    refresh:                        (p?: IconProps) => Icon.arrowsRotate({...p}),
    report:                         (p?: IconProps) => Icon.fileChart({...p}),
    save:                           (p?: IconProps) => Icon.floppyDisk({...p}),
    search:                         (p?: IconProps) => Icon.magnifyingGlass({...p}),
    selectDropdown:                 (p?: IconProps) => Icon.chevronDown({...p}),
    sortAbsAsc:                     (p?: IconProps) => Icon.arrowToTop({...p}),
    sortAbsDesc:                    (p?: IconProps) => Icon.arrowToBottom({...p}),
    sortAsc:                        (p?: IconProps) => Icon.arrowUp({...p}),
    sortDesc:                       (p?: IconProps) => Icon.arrowDown({...p}),
    success:                        (p?: IconProps) => Icon.checkCircle({...p}),
    sync:                           (p?: IconProps) => Icon.arrowsRotate({...p}),
    transaction:                    (p?: IconProps) => Icon.arrowRightArrowLeft({...p}),
    upload:                         (p?: IconProps) => Icon.arrowUpFromBracket({...p}),

...
export class ConfigPanel extends Component {
    ...
    gridModel = new RestGridModel({
        ...
        editors: this.filterForEnv([
            ...
            {field: 'groupName'},
            {field: 'valueType'},
            {field: 'prodValue', env: 'Production', maskIfPwd: true},
            {field: 'betaValue', env: 'Beta', maskIfPwd: true},
            {field: 'stageValue', env: 'Staging', maskIfPwd: true},
            {field: 'devValue', env: 'Development', maskIfPwd: true},
            {field: 'clientVisible'},

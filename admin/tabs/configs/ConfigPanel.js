...
export class ConfigPanel extends Component {
    ...
    gridModel = new RestGridModel({
        ...
        editors: this.filterForEnv([
            ...
            {field: 'groupName'},
            {field: 'valueType'},
            {field: 'prodValue', env: 'Production', checkForPwdVal: true},
            {field: 'betaValue', env: 'Beta', checkForPwdVal: true},
            {field: 'stageValue', env: 'Staging', checkForPwdVal: true},
            {field: 'devValue', env: 'Development', checkForPwdVal: true},
            {field: 'clientVisible'},

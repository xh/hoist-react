...
import {prefDifferDetail} from './PrefDifferDetail';
import {PrefDifferModel} from './PrefDifferModel';

export const prefDiffer = hoistCmp.factory({
    model: uses(PrefDifferModel),

    render({model}) {
        return fragment(
            dialog({
                title: 'Preference Differ',
                isOpen: model.isOpen,

    ...
    constructor({parentModel}) {
        ...
        this.gridModel = new GridModel({
            ...
            columns: [
                ...
                {field: 'msg', headerName: 'Message', flex: true, minWidth: 120, autosizeOptions: {maxWidth: 400}, filterable: true},
                {field: 'data', flex: true, minWidth: 120, autosizeOptions: {maxWidth: 400}, hidden: true},

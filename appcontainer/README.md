...
See `IdentityService` in [`/svc/README.md`](../svc/README.md) for the underlying impersonation
API.
...
app loads, and no Hoist-provided login UI is needed.
...
- [App Lifecycle](../docs/concepts/app-lifecycle.md) - App startup sequence and state machine

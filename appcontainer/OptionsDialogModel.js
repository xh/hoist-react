...
import {assign, mapValues, pickBy, hasKey} from 'lodash';
    ...
    async doSaveAsync() {
        const {formModel} = this,
            ...
            promises = this.options
                .filter(o => hasKey(dirtyFields, o.name))
        ...
        XH.track({
            ...
            category: 'App',
            data: mapValues(dirtyFields, f => ({oldValue: f.initialValue, newValue: f.value}))
        });
    }
}

...
import {navigatorBackButton, logoutButton, refreshButton} from '@xh/hoist/mobile/cmp/button';
...
export class AppBar extends Component {
    ...
    render() {
        const {navigatorModel, title, leftItems, rightItems, hideLogoutButton, hideRefreshButton, backButtonProps, refreshButtonProps = {}} = this.props;

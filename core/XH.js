 ...
 * @property {boolean} [allowEscape] - flag to specify whether a popup can be clicked out of or
 *      escaped.
 * @property {boolean} [cancelOnEscape] - flag to specify whether onCancel is executed when
